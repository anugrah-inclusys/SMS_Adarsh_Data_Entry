...
// const { excelDateToYMD, cleanRangeString, getTodayDate } = require('./uploadHelper');
...
//         assessment_details: row['content.sections.special_education.assessment_details'] || '',
//       },
//       { headers: { Authorization: `Bearer ${JWT_TOKEN}` } }
//     );
//     assessmentId = res.data.data._id;
//     console.log(`✅ Step 1 created comprehensive form for ${row['Student Name']}`);
//   } catch (err) {
...
//       step: 2,
//       payload: {
//         activities_of_daily_living: row['content.sections.special_education.activities_of_daily_living'] || '',
//       },
//     },
//     {
//       step: 3,
//       payload: {
//         medical_history: row['content.sections.special_education.medical_history'] || '',
//       },
//     },
//     {
//       step: 4,
//       payload: {
//         extra_curricular_activities: row['content.sections.special_education.extra_curricular_activities'] || '',
//       },
//     },
//     {
//       step: 5,
//       payload: {
//         assessment_details: row['content.sections.physiotherapy.assessment_details'] || '',
//       },
//     },
//     {
//       step: 6,
//       payload: {
//         assessment_details: row['content.sections.occupational_therapy.assessment_details'] || '',
//       },
//     },
//     {
//       step: 7,
//       payload: {
//         sensory_dysfunction: row['content.sections.occupational_therapy.sensory_dysfunction'] || '',
//       },
//     },
//     {
//       step: 8,
//       payload: {
//         assessment_details: row['content.sections.speech_and_language.assessment_details'] || '',
//       },
//     },
//     {
//       step: 9,
//       payload: {
//         assessment_details: row['content.sections.psychology.assessment_details'] || '',
//       },
//     },
//     {
//         step: 10,
...
//     } catch (err) {
//       console.error(`❌ Step ${step} failed`, err.response?.data || err.message);
//     }
//   }
...
//     console.log(`🎉 Comprehensive Assessment submitted for ${row['Student Name']}`);
//   } catch (err) {
...
//       { headers: { Authorization: `Bearer ${JWT_TOKEN}` } }
//     );
//     console.log(`🎯 Class change approved for ${row['Student Name']}`);const axios = require('axios');
    const xlsx = require('xlsx');
    const fs = require('fs');
    const FormData = require('form-data');
    const { API_BASE_URL, JWT_TOKEN } = require('../config/config');
