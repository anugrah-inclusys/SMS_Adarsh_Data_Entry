  ...
  const tabsStructure = [
    ...
    },
    {
      ...
      inputs: [
        "Identifies hunger",
        "Indicate hunger",
        "Place awareness (Kitchen, Dining area, Dining table, Chair)",
        "Identifies utensils (plate, glass, spoon, etc.)",
        "Preparations (Wash hands properly, Wash plates, Use napkin/towel)",
        "Table manners (Sit appropriately, Take required amount of food, Keep the food in correct position, Avoid wastage of food, Maintain proper discipline)",
    ...
    },
    {
      ...
      inputs: [
        ...
        "With glass: Identifies glass, Hold glass, Pour water into glass, Sip or suck with straw",
        "With bottle: Identifies bottle, Takes bottle, Fill water in the bottle, Sip or suck the nipple, Close the bottle",
