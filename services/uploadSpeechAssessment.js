  ...
  const steps = [
    {
      ...
      payload: {
        ...
        eye_contact_additional_details:
          row["content.prelinguistic_skills.eye_contact_additional_details"] ||
          "",
        name_call_response:
          row["content.prelinguistic_skills.name_call_response"] || "",
        name_call_response_additional_details:
          row[
            "content.prelinguistic_skills.name_call_response_additional_details"
          ] || "",
        sitting_behaviour:
          row["content.prelinguistic_skills.sitting_behaviour"] || "",
        sitting_behaviour_additional_details:
          row[
            "content.prelinguistic_skills.sitting_behaviour_additional_details"
          ] || "",
        attention: row["content.prelinguistic_skills.attention"] || "",
        attention_additional_details:
          row["content.prelinguistic_skills.attention_additional_details"] ||
          "",
      },
    },
    {
      ...
      payload: {
        ...
        cooing_additional_details:
          row["content.speech_development.cooing_additional_details"] || "",
        babbling: row["content.speech_development.babbling"] || "",
        babbling_additional_details:
          row["content.speech_development.babbling_additional_details"] || "",
        first_word: row["content.speech_development.first_word"] || "",
        first_word_additional_details:
          row["content.speech_development.first_word_additional_details"] || "",
        phrase: row["content.speech_development.phrase"] || "",
        phrase_additional_details:
          row["content.speech_development.phrase_additional_details"] || "",
        sentence: row["content.speech_development.sentence"] || "",
        sentence_additional_details:
          row["content.speech_development.sentence_additional_details"] || "",
      },
    },
    {
      step: 4,
    ...
    },
    {
      ...
      payload: {
        receptive_language_skills:
          row["content.language_skills.receptive_language_skills"] || "",
        expressive_language_skills:
          row["content.language_skills.expressive_language_skills"] || "",
      },
    },
    {
      step: 6,
      payload: {
        ...
        lips_function_protrusion:
          row["content.opme.lips.function.protrusion"] || "",
        lips_function_spreading:
          row["content.opme.lips.function.spreading"] || "",
        lips_function_rounding:
          row["content.opme.lips.function.rounding"] || "",
        lips_function_puckering:
          row["content.opme.lips.function.puckering"] || "",
        tongue_structure: row["content.opme.tongue.structure"] || "",
        tongue_function_elevation:
          row["content.opme.tongue.function.elevation"] || "",
        tongue_function_spreading:
          row["content.opme.tongue.function.spreading"] || "",
        tongue_function_lateral_movements:
          row["content.opme.tongue.function.lateral_movements"] || "",
        tongue_function_retraction:
          row["content.opme.tongue.function.retraction"] || "",
        ...
        maxilla_and_mandible_structure:
          row["content.opme.maxilla_and_mandible.structure"] || "",
        maxilla_and_mandible_function:
          row["content.opme.maxilla_and_mandible.function"] || "",
    ...
    },
    {
      ...
      payload: {
        sucking:
          String(
            row["content.vegetative_skills.sucking"] || ""
          ).toLowerCase() === "true",
        chewing:
          String(
            row["content.vegetative_skills.chewing"] || ""
          ).toLowerCase() === "true",
        blowing:
          String(
            row["content.vegetative_skills.blowing"] || ""
          ).toLowerCase() === "true",
        biting:
          String(
            row["content.vegetative_skills.biting"] || ""
          ).toLowerCase() === "true",
        swallowing:
          String(
            row["content.vegetative_skills.swallowing"] || ""
          ).toLowerCase() === "true",
      },
    },
    {
      step: 9,
      payload: {
        speech_imitation_rating:
          row["content.speech_imitation_skills.rating"] || "",
        speech_imitation_comment:
          row["content.speech_imitation_skills.comment"] || "",
      },
    },
    {
      step: 10,
      payload: {
        speech_intelligibility_rating:
          row["content.speech_intelligibility.rating"] || "",
        speech_intelligibility_comment:
          row["content.speech_intelligibility.comment"] || "",
      },
    },
    {
      step: 11,
    ...
    },
    {
      ...
      payload: {
        ...
        stimulation_at_home:
          row["content.linguistic_skills.stimulation_at_home"] || "",
      },
    },
    {
      step: 13,
    ...
    },
    {
      ...
      payload: {
        ...
        sessions_per_week:
          cleanRangeString(row["content.plan_of_action.sessions_per_week"]) ||
          "",
      },
    },
  ];
